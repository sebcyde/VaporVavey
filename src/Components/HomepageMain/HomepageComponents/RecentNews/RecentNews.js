		...
		<div>
			<div className="RecentNews">
				...
				<p>
					...
					<br />
					<br />
					Suspendisse sed nisi lacus sed viverra. Nulla facilisi etiam dignissim
					diam quis enim lobortis. Purus viverra accumsan in nisl nisi
					scelerisque. Ut enim blandit volutpat maecenas volutpat blandit. Est
					sit amet facilisis magna etiam tempor orci eu. Proin nibh nisl
					condimentum id venenatis a condimentum vitae. Cursus metus aliquam
					eleifend mi in nulla posuere sollicitudin aliquam. Varius vel pharetra
					vel turpis nunc eget lorem dolor sed. Ligula ullamcorper malesuada
					proin libero. Lorem dolor sed viverra ipsum. Eleifend mi in nulla
					posuere sollicitudin aliquam ultrices sagittis. Vestibulum mattis
					ullamcorper velit sed ullamcorper. Sed ullamcorper morbi tincidunt
					ornare massa eget egestas. Habitasse platea dictumst vestibulum
					rhoncus est pellentesque elit. Congue nisi vitae suscipit tellus
					mauris. Facilisis magna etiam tempor orci eu lobortis elementum nibh
					tellus. Egestas sed sed risus pretium quam vulputate dignissim
					suspendisse in. Molestie ac feugiat sed lectus vestibulum mattis.
				</p>
